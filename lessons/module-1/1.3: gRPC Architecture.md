...
1. **What are the four types of gRPC services?**
   <details><summary>Click for answer</summary>Unary (1→1), Server Streaming (1→many), Client Streaming (many→1), Bidirectional Streaming (many→many)</details>
...
<details>
<summary>🔍 Click to see suggested solution</summary>
